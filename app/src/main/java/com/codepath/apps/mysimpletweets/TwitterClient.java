...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "j3gtKCXXIe2nMu16S6zbdU43U";       // Change this
	public static final String REST_CONSUMER_SECRET = "5tDXJkZvqjfVpX7e5bfoZWJ4piJ1jjD9Tnc90VOKvstrQazrjB"; // Change this
	...
	public void getOldMentions(long maxId,JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/mentions_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
	...
	public void postTweet(String tweetBody,JsonHttpResponseHandler handler){
	...
	public void replyToTweet(String tweetBody,long statusId,JsonHttpResponseHandler handler){
		String apiUrl = getApiUrl("statuses/update.json");
		RequestParams params = new RequestParams();
		params.put("status",tweetBody);
	...
	public void getNewTweets(long sinceId,AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", 25);
